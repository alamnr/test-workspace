...
public class DateTest {
    ...
    public void parse_custom(String dateText, ZonedDateTime dateValue) throws ParseException {
            //DateTimeFormatter dtf = ISODateFormat.UNMARSHALLER;
        ...
        Assertions.assertThat(zdt).isEqualTo(dateValue);
        Assertions.assertThat(odt).isEqualTo(dateValue.toOffsetDateTime());
